...
//    
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if (screen == 5){
            ...
            g.fillRect(l4b1.x - camx, l4b1.y ,  l4b1.width, l4b1.height);
